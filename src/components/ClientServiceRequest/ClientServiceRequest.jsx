              ...
              <FormControl>
                ...
                <div>
                  ...
                  >
                    ...
                    <Select
                      onChange={(event) =>
                        this.handleChange(event, "service_select")
                      }
                    ...
                    <FormGroup row={true}>
                      {this.props.petInfo.map((pet) => (
                        <FormControlLabel
                          ...
                          value={pet.id}
                          onChange={(event) =>
                            this.handleChecks(event, "pet_id")
                          }
                          label={pet.pet_name}
                        />
                      ))}
                ...
                <Typography variant="h6">
                  Please select the dates requesting for service:
                </Typography>
                <br />
                <div>
                  <div>
                    ...
                    <DatePicker
                      ...
                      onChange={(event) =>
                        this.handleDateChange(event, "start_date_time")
                      }
                    />
                    ...
                    <DatePicker
                      ...
                      onChange={(event) =>
                        this.handleDateChange(event, "end_date_time")
                      }
                    />
                  </div>
                  <div>
                    <TextField
                      ...
                      onChange={(event) =>
                        this.handleChange(event, "input_info")
                      }
                      fullWidth
                      multiline
                      rows={10}
